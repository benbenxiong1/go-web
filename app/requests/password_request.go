// Package requests  user : benbenxiong  time : 2023-14-2023/6/14 20:20:15
package requests
...
func ResetByPhone(data interface{}) map[string][]string {
	...
	errs = validators.ValidateCaptcha(_data.Phone, _data.VerifyCode, errs)
...
func ResetByEmail(data interface{}) map[string][]string {
	rules := govalidator.MapData{
